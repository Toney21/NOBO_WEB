            ...
            >
                ...
                <Grid item xs={12} mb="1.3rem">
                    ...
                    >
                        <DollarSignHighlighter
                            text={t('We deliver across Nairobi, and growing fast')}
                        />
                    </Typography>
                    <Typography
                        ...
                        component="p"
                    >
                        {t("We're expanding our network every week. If we're not in your area yet, tell us where to go next.")}
                    </Typography>
                </Grid>

                {/* Available zone list with background image. */}
                <Grid
                    item
                    xs={12}
                    md={6}
                ...
                {landingPageData?.available_zone_location_picker_status ? (
                    ...
                    >
                        ...
                        >
                            {
                                t('Enter your location to see whether NOBO is already serving your neighborhood.')
                            }
                        </Typography>
