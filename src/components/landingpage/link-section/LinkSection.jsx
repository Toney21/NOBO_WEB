                ...
                <Grid item xs={12} sm={12} md={6}>
                    <CustomCard>
                        ...
                        >
                            ...
                            >
                                <BusinessCenterIcon sx={{ fontSize: isSm ? 32 : 36 }} />
                            </Box>
                            <Stack
                                direction="row"
                                flexWrap="wrap"
                            ...
                            >
                                <Stack>
                                    ...
                                    <Typography
                                        ...
                                        component="p"
                                    >
                                        {t('NOBO helps companies manage team meals effortlessly, with centralized billing, employee controls, and seamless ordering.')}
                                    </Typography>
                                </Stack>
                                <PrimaryButton
                                    onClick={TeamOrderingRegister}
                                    sx={{
                                        borderRadius: '8px',
                                        paddingY: {
                                            xs: '5px',
