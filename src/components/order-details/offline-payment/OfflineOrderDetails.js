...
const OfflineOrderDetails = ({ trackData, refetchTrackData }) => {
    ...
    const paymentStatusText = trackData?.payment_status_label
        ? trackData?.payment_status_label
        : trackData?.payment_status === 'paid'
          ? t('Paid')
          : t('Unpaid')
    const paymentStatusColor =
        trackData?.payment_method === 'corporate_account' &&
        trackData?.payment_status_label
                ...
                <Stack flexDirection="row">
                    ...
                    >
                        ...
                        trackData?.payment_method !== 'partial_payment'
                            ...
                            : trackData?.payment_method_label ||
