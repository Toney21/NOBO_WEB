...
const styledButtonProps = ['radiuschange', 'languageDirection']

export const StyledButton = styled(CustomButtonPrimary, {
    shouldForwardProp: (prop) => !styledButtonProps.includes(prop),
})(
...
const cssTextFieldProps = ['languageDirection', 'mobileview', 'getLocation']

export const CssTextField = styled(TextField, {
    shouldForwardProp: (prop) => !cssTextFieldProps.includes(prop),
})(
