...
const VisitAgain = () => {
    ...
    const trySomethingNewTitle = t("Let's Try Something New")
    const trySomethingNewSubTitle = t(
        'Our Latest Recommendations Just for You!'
    )
    const [text, setText] = useState({
        title: trySomethingNewTitle,
        subTitle: trySomethingNewSubTitle,
    })
    ...
    const shouldRenderRecommendationSection =
        userData?.length > 0 ||
        isLoading ||
        isLoadingRecent ||
    ...
    return (
        <Grid container spacing={3} paddingTop="30px">
            ...
            {shouldRenderRecommendationSection && (
                <Grid
                    item
                    xs={12}
                    md={8.5}
